<template>
	<fs-page>
		...
		<el-drawer v-model="drawerVisible" title="学校配置" direction="rtl" size="500px" :close-on-click-modal="false" :before-close="handleDrawerClose">
			<DeptFormCom
				v-if="drawerVisible"
...
const handleDeleteMenu = (id: string, callback: Function) => {
	ElMessageBox.confirm('您确认删除该学校吗?', '温馨提示', {
